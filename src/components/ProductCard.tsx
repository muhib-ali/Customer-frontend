        ...
        <CardFooter className="p-4 pt-0 flex items-center justify-between border-t border-border/50 mt-auto">
          ...
          {inCart ? (
            <Button
              ...
              size="sm"
              className="w-full bg-green-600 hover:bg-green-700 text-white font-bold uppercase tracking-wider rounded-none transition-all duration-300 group-hover:shadow-md"
            >
            ...
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-white font-bold uppercase tracking-wider rounded-none transition-all duration-300 group-hover:shadow-md disabled:opacity-50"
            >
              <ShoppingCart className="mr-2 h-4 w-4" />
